      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img class="h-8 w-8" src="https://oop.devserver.ro/images/mark.svg" alt="Your Company">
          </div>
            ...
            <div class="relative ml-3 flex gap-5">
              <div>
                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/25511379?v=4" alt="">
                    <? else : ?>
                        <a href="/register" class="text-white pr-3">Register</a>
