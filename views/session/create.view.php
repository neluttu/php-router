                ...
                <div class="mt-5">
                    <form action="/session" method="post">
                        <div class="relative mt-6">
                            <input type="text" name="email" id="email" value="<?= old('email') ?? '' ?>" placeholder="Email Address" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" autocomplete="NA" />
                        ...
                        <p class="text-center text-sm text-gray-500">Not registered?
                            <a href="/register"
                                class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">Register now
                            </a>.
                        </p>
                    </form>
                </div>
